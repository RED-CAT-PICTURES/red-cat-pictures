...
<template>
  <button aria-label="switch-theme" class="relative h-fit w-fit cursor-pointer rounded-full border border-white bg-white p-2 dark:border-black dark:bg-black" @click="toggleDark()">
