...
<template>
  <section id="hero" class="text-shadow-lg grid h-dvh grid-cols-3 grid-rows-[repeat(3,min-content)] items-center gap-y-[4.5rem] text-white md:px-16 lg:grid-rows-1">
