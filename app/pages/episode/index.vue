...
const imageUrl = episodes.value?.length ? `${cdnUrl}/media/image/f_jpeg&fit_cover&s_1200x630/${extractCdnId(episodes.value[0]?.cover)}/` : `${siteUrl}/previews/placeholder-empty.jpg`
