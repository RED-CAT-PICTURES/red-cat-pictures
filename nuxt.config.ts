...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/api/**': { cors: true },
    '/image': { redirect: { to: '/media', statusCode: 301 } },
    '/image/**': { redirect: { to: '/photo/**', statusCode: 301 } },
    '/images': { redirect: { to: '/media', statusCode: 301 } },
    '/images/**': { redirect: { to: '/photo/**', statusCode: 301 } },
    '/photos': { redirect: { to: '/media', statusCode: 301 } },
    '/photos/**': { redirect: { to: '/photo/**', statusCode: 301 } },
    '/photo': { redirect: { to: '/media', statusCode: 301 } },
    '/photo/**': { isr: 3600 },
    '/videos': { redirect: { to: '/media', statusCode: 301 } },
    '/videos/**': { redirect: { to: '/video/**', statusCode: 301 } },
    '/video': { redirect: { to: '/media', statusCode: 301 } },
    '/video/**': { isr: 3600 },
    '/media/**': { isr: 3600 },
